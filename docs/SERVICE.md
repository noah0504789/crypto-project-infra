...
> notification(blue/green)·market-detection(safe-recreate)은 추가 예정 — 루트 `TODO.md` 참고.
...
- blue/green(user/market/chat/websocket-gateway)·validated-recreate(config/eureka/api-gateway/
